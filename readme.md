...
- ```PieceTypes``` are the different types of pices, Pawns, Rocks, King, Queens etc. The Pawn PieceType contains info wether or not it can be captured by en passant.
...
How to create the default setup of the pices get all moves, make a move, and display the position afterwards.
...
To create the default setup of the pices and then play a whole game provided a pick_move function.
